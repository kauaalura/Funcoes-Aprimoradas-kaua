        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Você encontrou uma floresta misteriosa e optou pelo caminho claro e seguro.",
                    "Afirmação 2"
                ]    
            },
            {
                ...
                afirmacao: [
                    "Você encontrou uma floresta misteriosa e optou seguir pelo caminho misterioso e sombrio",
                    "Afirmação 2"
                ]
            }
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Ao ouvir um som estranho, enfrenta sem qualquer medo e seguro de sí.",
                    "Afirmação 2"
                ]
            },
            {
                ...
                afirmacao: [
                    "Ao ouvir um som estranho, o ignora e segue seu caminho rapidamente.",
                    "Afirmação 2"
                ]
            }
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Encontra um viajante, então oferece ajuda e compartilha seus mantimentos.",
                    "Afirmação 2"
                ]
            },
            {
                ...
                afirmacao: [
                    "Encontra um viajante, porém, decide seguir sem parar, focado em seu destino.",
                    "Afirmação 2"
                ]
            }
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Em uma tomada de decisão, em encontrar um lugar para passar a noite, você vai acampar em uma caverna que parece segura.",
                    "Afirmação 2"
                ]
            },
            {
                ...
                afirmacao: [
                    "Em uma tomada de decisão, em encontrar um lugar para passar a noite, decide ir para uma clareira ao ar livre, com vista para as estrelas.",
                    "Afirmação 2"
                ]
            }
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Já no final da jornada, encontra um portal, que decide entrar pela sua curiosidade.",
                    "Afirmação 2"
                ]
            },
            {
                ...
                afirmacao: [
                    "Já no final da jornada, encontra um portal, mas decide evitar qualquer risco, pois quer explorar o mundo.",
                    "Afirmação 2"
                ]
            }
        ]
